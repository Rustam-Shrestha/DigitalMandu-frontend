...
const Register = () => {
    ...
    const [userData, setUserData] = useState({
      // use the key you accept in the backend here and also write its name in name="" field of xml at the bottom otherwise it will not recognize
        userName: "",
        userPhone: "",
        userEmail: "",
        userPassword: "",
          ...
          <div className="mt-20 bg-white w-17/12 lg:w-5/12 md:6/12 shadow-3xl ">
              ...
              <form className="p-3 md:p-10" onSubmit={handleSubmit}>
                  <div className="flex items-center mb-6 text-lg md:mb-8">
                      ...
                      <input type="text" id="email" name="userEmail" onChange = {handleChange} className="w-full py-2 pl-12 bg-gray-200 md:py-4 focus:outline-none" placeholder="Email" />
                  </div>
                  <div className="flex items-center mb-6 text-lg md:mb-8">
                      <svg className="absolute ml-3" width="24" viewBox="0 0 24 24">
                          <path d="M20.822 18.096c-3.439-.794-6.64-1.49-5.09-4.418 4.72-8.912 1.251-13.678-3.732-13.678-5.082 0-8.464 4.949-3.732 13.678 1.597 2.945-1.725 3.641-5.09 4.418-3.073.71-3.188 2.236-3.178 4.904l.004 1h23.99l.004-.969c.012-2.688-.092-4.222-3.176-4.935z" />
                      </svg>
                      <input type="number" id="phone" name="userPhone" onChange = {handleChange}  maxLength='10' className="w-full py-2 pl-12 bg-gray-200 md:py-4 focus:outline-none" placeholder="phone number" />
                  </div>
                  <div className="flex items-center mb-6 text-lg md:mb-8">
                      <svg className="absolute ml-3" width="24" viewBox="0 0 24 24">
                          <path d="M20.822 18.096c-3.439-.794-6.64-1.49-5.09-4.418 4.72-8.912 1.251-13.678-3.732-13.678-5.082 0-8.464 4.949-3.732 13.678 1.597 2.945-1.725 3.641-5.09 4.418-3.073.71-3.188 2.236-3.178 4.904l.004 1h23.99l.004-.969c.012-2.688-.092-4.222-3.176-4.935z" />
                      </svg>
                      <input type="text" id="username" name="userName" onChange = {handleChange}  className="w-full py-2 pl-12 bg-gray-200 md:py-4 focus:outline-none" placeholder="Username" />
                  </div>
                  <div className="flex items-center mb-6 text-lg md:mb-8">
